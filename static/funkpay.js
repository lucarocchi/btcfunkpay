  ...
  var _HTML = `
    <div class="card">
      ...
      <form id="form">
        ...
        <div class="pay-hint">
          Enter fiat or BTC — fields sync automatically.<br>Click <b>Pay</b>, scan the QR with your Bitcoin wallet and<br>Send.<br><a href="https://github.com/lucarocchi/btcfunkpay" target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;text-underline-offset:2px;">Open source · MIT</a>
        </div>
